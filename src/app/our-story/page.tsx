...
export const metadata: Metadata = {
  ...
  description:
    'Learn about Human Health Care Services Pvt Ltd, a Pakistani company providing top healthcare services in Karachi and beyond.',
};
...
const foundingPhotos = [
  ...
  {
    name: 'Dr. Mahwash Siddiqui',
    title: 'Co-Founder & US-Based Endocrinologist.',
    image: '/images/team/mehwish.jpg',
  },
  {
    name: 'Dr. Shoib Ghayas',
    title: 'Co-Founder & UK-Based General Physician.',
    image: '/images/team/shoaib-ghayas.jpg',
  },
];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Our Story is Every Pakistani&apos;s Story
            </h1>
            <p className="text-xl text-gray-100 leading-relaxed">
              Discover the journey of Human Health Care Services and our
              commitment to providing exceptional healthcare services to
              families across Pakistan and overseas Pakistanis worldwide.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            {teamMembers.map((member, index) => (
              <div key={member.id}>
                <div
                  className={`flex flex-col ${member.position === 'left' ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-8 items-start mb-16`}
                >
                  {/* Photo */}
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-6 text-left">
              <p className="text-[16px] leading-[25.6px] text-[#111111] font-poppins">
                Your loved ones get VIP Personalized Care service that offers
                comprehensive health monitoring for loved ones in Pakistan. The
                service includes US board-certified specialists who work with
                local expert doctors to provide personalized care. The team
                includes specialists in hypertension, diabetes(endocrinology),
                rheumatology, oncology, hematology, neurology, pulmonology,
                nephrology, cardiology, gastroenterology, pediatrics, and
                geriatrics among others.
              </p>

              <p className="text-[16px] leading-[25.6px] text-[#111111] font-poppins">
                The service also offers regular check-ups with monthly visits
                and an urgent as-needed visit system for new medical problems
                that can often happen in your loved ones. The team collects
                valuable health data with cutting-edge gadgets and provides
                frequent updates through a mobile app.
              </p>
            </div>
          </div>
        </div>
