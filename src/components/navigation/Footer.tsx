    ...
    <footer className="bg-[#343434] text-white py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 mr-8">
            <h3 className="text-[24px] leading-[31.2px] text-[#ffffff] font-poppins mb-6">Get in Touch</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <a href="tel:+923192060174" className="text-[15px] leading-[22.4px] text-[#ffffff] font-poppins hover:text-[#a048a7]">
                  +92 319-2060174
                </a>
              </div>

              <div className="flex items-center">
                <svg className="w-4 h-4 text-[#a048a7] mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://wa.me/+13199363574" className="text-[15px] leading-[22.4px] text-[#ffffff] font-poppins hover:text-[#a048a7]">
                  +1 319 936 3574
                </a>
              </div>
          ...
          <div className="flex-1 mr-6">
            <h3 className="text-[24px] leading-[31px] text-[#ffffff] font-dm-sans mb-6">Quicklinks</h3>
          ...
          <div className="flex-1">
            <h3 className="text-[24px] leading-[31px] text-[#ffffff] font-dm-sans mb-6">Newsletter</h3>
            <div className="space-y-4">
              <div>
                <input
                  type="email"
        ...
        <div className="mt-6 pt-3 border-t border-[#343434]">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center mb-4 md:mb-0">
              <a href="/service-agreement" className="text-white hover:text-[#a048a7] text-sm">
                Service Agreement
              </a>
            </div>
